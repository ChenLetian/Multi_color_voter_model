...
int main(int argc, char *argv[])
{
	...
	sprintf(FILE_NAME,"Collision_detailed_total_pairs_%d_%d_%g_%d_%d.txt",linear_size,num_species,dif_specie,tfin,thread);
	...
	Simulation_collisions_detailed_pairs simulation(dynamics,tfin,trials,refresh_time,thread,FILE_NAME,num_species);
