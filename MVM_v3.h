...
class Simulation_collisions_detailed_pairs: public Simulation_collisions{
	...
	public:
		...
		void sequential_time_step(gsl_rng *r);
...
void Simulation_collisions_detailed_pairs::get_pairs(){
...
void Simulation_collisions_detailed_pairs::sequential_time_step(gsl_rng *r){
